...
[HarmonyPatch]
internal static class GiantCreaturesPatch
{
	[CompilerGenerated]
	...
	{
		if (PlusState.IsGiantCreaturesActive() && GameReflection.IsEnemyCreature(__instance) && AppliedTracker.MarkGiantCreature(__instance))
		{
